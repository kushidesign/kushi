...
;; (defn secondary* [k n]
;;   {:bgc       (tok* k n)
;;    :hover:bgc (tok* k (+ n (if (= n 50) 50 100)))
;;    :color     (tok* k)})

;; (defn dark-secondary* [k n]
;;   {:bgc       (tok* k n)
;;    :hover:bgc (tok* k (- n 100))
;;    :color     (tok* k 50)})

;; (defn dark-tertiary* [k n]
;;   {:bgc       :transparent
;;    :hover:bgc (tok* k n)
;;    :color     (tok* k 200)})
...
(def ui
  {:body                                  {:font-family :--sans-serif-font-stack
   ...
   ;; ------------------------------------------------------
   :.accent                               accent*
   ".dark .accent"                          accent-inverse*
   :.positive                             positive*
   ".dark .positive"                        positive-inverse*
   :.warning                              warning*
   ".dark .warning"                         warning-inverse*
   :.negative                             negative*
   ".dark .negative"                        negative-inverse*
