...
(defui radio 
  {:doc   "This is radio docstring"
   :props/shared [:text-size :transition :text-weight]}
  [& args]  [:input
   (merge-attrs
    {:class            (css
                        ".ks-radio"
