...
(css-string "kushi-ui-theming"
            "[data-ks-surface],
[data-ks-surface]&[data-ks-interactive]:hover, 
[data-ks-surface]&[data-ks-interactive]:active {
  &[data-ks-colorway=gray], &[data-ks-colorway=neutral], &:not([data-ks-colorway]) {
    --chroma-shift:   0%;
    --colorway-hue:   var(--neutral-hue-oklch);
    --chroma-bgc:     0%;
    --chroma-fgc:     0%;
  }
  &[data-ks-colorway=sand], &[data-ks-colorway=slate] {
    --chroma-shift: 1%;
    .dark & {
      --chroma-shift: 1%;
    }
...
(defcss "[data-ks-surface=solid], [data-ks-surface=solid-classic], [data-ks-surface=soft], [data-ks-surface=soft-classic], [data-ks-surface=faint], [data-ks-surface=convex], [data-ks-surface=minimal], [data-ks-surface=transparent], [data-ks-surface=minimal-light-mode], [data-ks-surface=convex-light-mode]"
  {:--hover-bgc-chroma  "calc(var(--chroma-bgc) + var(--chroma-shift))"
   ...
   :--active-bgc        "oklch(calc(var(--lightness-bgc) + (2 * var(--lightness-shift))) var(--active-bgc-chroma) var(--colorway-hue))"
...
(defcss "[data-ks-colorway=neutral][data-ks-surface=convex], [data-ks-colorway=neutral][data-ks-surface=convex-light-mode]"
  {:dark {:--convex-shadow-chroma        "var(--chroma-bgc)"
