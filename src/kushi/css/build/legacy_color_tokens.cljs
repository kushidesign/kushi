(ns ^{:kushi/layer "design-tokens"} kushi.css.build.legacy-color-tokens
  (:require
...
(defcss
  ":root"
   ...
   ["--neutral-info-background-color-active-inverse"
   "var(--neutral-750)"]
   ...
   ["--neutral-minimal-background-color-hover-inverse"
   "var(--neutral-850)"]
   ["--neutral-minimal-background-color-active-inverse"
   "var(--neutral-800)"]
   ...
   ["--neutral-bordered-info-background-color-hover-inverse"
   "transparent"]
   ["--neutral-bordered-info-background-color-active-inverse"
   "transparent"]
   ["--neutral-bordered-info-border-color-inverse" "var(--neutral-50)"]
   ["--neutral-bordered-info-border-color-hover-inverse"
   "var(--neutral-50)"]
   ["--neutral-bordered-info-border-color-active-inverse"
   "var(--neutral-50)"]
   ...
   ["--neutral-filled-background-color-hover-inverse"
   "var(--neutral-100)"]
   ["--neutral-filled-background-color-active-inverse"
   "var(--neutral-50)"]
   ["--neutral-filled-info-background-color-inverse"
   "var(--neutral-250)"]
   ["--neutral-filled-info-background-color-hover-inverse"
   "var(--neutral-250)"]
   ...
   ["--accent-minimal-background-color-hover-inverse"
   "var(--accent-750)"]
   ["--accent-minimal-background-color-active-inverse"
   "var(--accent-850)"]
   ...
   ["--accent-bordered-info-background-color-hover-inverse"
   "transparent"]
   ["--accent-bordered-info-background-color-active-inverse"
   "transparent"]
   ["--accent-bordered-info-border-color-inverse" "var(--accent-300)"]
   ["--accent-bordered-info-border-color-hover-inverse"
   "var(--accent-300)"]
   ["--accent-bordered-info-border-color-active-inverse"
   "var(--accent-300)"]
   ...
   ["--accent-filled-background-color-active-inverse"
   "var(--accent-100)"]
   ["--accent-filled-info-background-color-inverse" "var(--accent-400)"]
   ["--accent-filled-info-background-color-hover-inverse"
   "var(--accent-400)"]
   ...
   ["--positive-filled-info-background-color-hover"
   "var(--positive-650)"]
   ...
   ["--positive-info-background-color-hover-inverse"
   "var(--positive-800)"]
   ["--positive-info-background-color-active-inverse"
   "var(--positive-800)"]
   ...
   ["--positive-minimal-background-color-hover-inverse"
   "var(--positive-800)"]
   ["--positive-minimal-background-color-active-inverse"
   "var(--positive-700)"]
   ...
   ["--positive-bordered-border-color-hover-inverse"
   "var(--positive-150)"]
   ["--positive-bordered-border-color-active-inverse"
   "var(--positive-50)"]
   ["--positive-bordered-info-color-inverse" "var(--positive-350)"]
   ["--positive-bordered-info-color-hover-inverse" "var(--positive-350)"]
   ["--positive-bordered-info-color-active-inverse"
   "var(--positive-350)"]
   ["--positive-bordered-info-background-color-inverse" "transparent"]
   ["--positive-bordered-info-background-color-hover-inverse"
   "transparent"]
   ["--positive-bordered-info-background-color-active-inverse"
   "transparent"]
   ["--positive-bordered-info-border-color-inverse"
   "var(--positive-350)"]
   ["--positive-bordered-info-border-color-hover-inverse"
   "var(--positive-350)"]
   ["--positive-bordered-info-border-color-active-inverse"
   "var(--positive-350)"]
   ...
   ["--positive-filled-background-color-hover-inverse"
   "var(--positive-350)"]
   ["--positive-filled-background-color-active-inverse"
   "var(--positive-250)"]
   ["--positive-filled-info-background-color-inverse"
   "var(--positive-500)"]
   ["--positive-filled-info-background-color-hover-inverse"
   "var(--positive-500)"]
   ...
   ["--negative-filled-info-background-color-hover"
   "var(--negative-600)"]
   ...
   ["--negative-info-background-color-hover-inverse"
   "var(--negative-800)"]
   ["--negative-info-background-color-active-inverse"
   "var(--negative-800)"]
   ...
   ["--negative-minimal-background-color-hover-inverse"
   "var(--negative-850)"]
   ["--negative-minimal-background-color-active-inverse"
   "var(--negative-750)"]
   ...
   ["--negative-bordered-border-color-hover-inverse"
   "var(--negative-250)"]
   ["--negative-bordered-border-color-active-inverse"
   "var(--negative-150)"]
   ["--negative-bordered-info-color-inverse" "var(--negative-350)"]
   ["--negative-bordered-info-color-hover-inverse" "var(--negative-350)"]
   ["--negative-bordered-info-color-active-inverse"
   "var(--negative-350)"]
   ["--negative-bordered-info-background-color-inverse" "transparent"]
   ["--negative-bordered-info-background-color-hover-inverse"
   "transparent"]
   ["--negative-bordered-info-background-color-active-inverse"
   "transparent"]
   ["--negative-bordered-info-border-color-inverse"
   "var(--negative-350)"]
   ["--negative-bordered-info-border-color-hover-inverse"
   "var(--negative-350)"]
   ["--negative-bordered-info-border-color-active-inverse"
   "var(--negative-350)"]
   ...
   ["--negative-filled-background-color-hover-inverse"
   "var(--negative-350)"]
   ["--negative-filled-background-color-active-inverse"
   "var(--negative-250)"]
   ["--negative-filled-info-background-color-inverse"
   "var(--negative-450)"]
   ["--negative-filled-info-background-color-hover-inverse"
   "var(--negative-450)"]
   ...
   ["--warning-info-background-color-active-inverse"
   "var(--warning-850)"]
   ...
   ["--warning-minimal-background-color-hover-inverse"
   "var(--warning-850)"]
   ["--warning-minimal-background-color-active-inverse"
   "var(--warning-750)"]
   ...
   ["--warning-bordered-border-color-active-inverse"
   "var(--warning-200)"]
   ...
   ["--warning-bordered-info-background-color-hover-inverse"
   "transparent"]
   ["--warning-bordered-info-background-color-active-inverse"
   "transparent"]
   ["--warning-bordered-info-border-color-inverse" "var(--warning-450)"]
   ["--warning-bordered-info-border-color-hover-inverse"
   "var(--warning-450)"]
   ["--warning-bordered-info-border-color-active-inverse"
   "var(--warning-450)"]
   ...
   ["--warning-filled-background-color-hover-inverse"
   "var(--warning-350)"]
   ["--warning-filled-background-color-active-inverse"
   "var(--warning-250)"]
   ["--warning-filled-info-background-color-inverse"
   "var(--warning-500)"]
   ["--warning-filled-info-background-color-hover-inverse"
   "var(--warning-500)"]
   ...
   ["--neutral-foreground-inverse"
   "var(--neutral-minimal-color-inverse)"]
   ...
   ["--positive-foreground-inverse"
   "var(--positive-minimal-color-inverse)"]
   ["--warning-foreground" "var(--warning-minimal-color)"]
   ["--warning-foreground-inverse"
   "var(--warning-minimal-color-inverse)"]
   ...
   ["--foreground-color-negative" "var(--negative-650)"]
   ["--foreground-color-gray" "var(--gray-650)"]
   ["--foreground-color-purple" "var(--purple-650)"]
   ["--foreground-color-blue" "var(--blue-650)"]
   ["--foreground-color-green" "var(--green-650)"]
   ["--foreground-color-lime" "var(--lime-650)"]
   ["--foreground-color-yellow" "var(--yellow-650)"]
   ["--foreground-color-gold" "var(--gold-650)"]
   ["--foreground-color-orange" "var(--orange-650)"]
   ["--foreground-color-red" "var(--red-650)"]
   ["--foreground-color-magenta" "var(--magenta-650)"]
   ["--foreground-color-brown" "var(--brown-650)"]
   ["--foreground-color-accent-inverse" "var(--accent-350)"]
   ["--foreground-color-warning-inverse" "var(--warning-350)"]
   ["--foreground-color-positive-inverse" "var(--positive-350)"]
   ["--foreground-color-negative-inverse" "var(--negative-350)"]
   ["--foreground-color-gray-inverse" "var(--gray-350)"]
   ["--foreground-color-purple-inverse" "var(--purple-350)"]
   ["--foreground-color-blue-inverse" "var(--blue-350)"]
   ["--foreground-color-green-inverse" "var(--green-350)"]
   ["--foreground-color-lime-inverse" "var(--lime-350)"]
   ["--foreground-color-yellow-inverse" "var(--yellow-350)"]
   ["--foreground-color-gold-inverse" "var(--gold-350)"]
