...
;; Finish readme (almost there)
;; Commit to repo

;; Release new alpha
;; release new qs
;; release new pg
;; deploy doc site at kushi.design
...
;; ?? make sure styles/defclasses/utility classes in right order (:kushi/kushi-ui-defclass)


;; make text field thing / toggle thing
...
;; check caching for changes with config

;; playground ns bundle up
